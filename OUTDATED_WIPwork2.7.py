...
def pdf_setup(type):
    ...
    if powerpoint_window is not None:
        ...
        time.sleep(.5)
        pa.click(23,45, duration=.25)
        time.sleep(.1)
        pa.click(66,317)
        time.sleep(.1)
        pa.doubleClick(273,383)
        time.sleep(.2)
...
# from top left
        ...
        if type == 'png':
            ...
            pa.write(r"C:\Users\ols00175\Desktop\Production")
        time.sleep(.1)
        pa.press('enter')
...
# to ensure drop down menu goes down
        ...
        location = pa.getActiveWindow().left+132, pa.getActiveWindow().bottom-260
        pa.click(location)
...
def create_handouts():
    ...
    pa.click()
    location = pa.getActiveWindow().right-132, pa.getActiveWindow().bottom-260
